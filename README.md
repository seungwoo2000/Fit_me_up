...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:1e1b4b,50:4f46e5,100:818cf8&height=220&section=header&text=🧘%20자세히봐&fontSize=60&fontColor=ffffff&fontAlignY=40&desc=AI가%20당신의%20자세와%20작업%20환경을%20실시간으로%20분석합니다&descAlignY=62&descColor=c7d2fe&animation=fadeIn" alt="header" width="100%"/>
...
> **앉은 자세 + 작업 환경을 동시에 분석하는 실시간 AI 자세 교정 시스템**  
...
```
"장시간 앉아서 일하는 현대인의 잘못된 자세, AI가 실시간으로 잡아줍니다."
...
동시에 분석하여 실시간 교정 피드백을 제공하는 **컴퓨터 비전 헬스케어 프로젝트**입니다.
...
|:---|:---|:---|
| 👁️ **컴퓨터 비전** | MediaPipe · YOLOv8 · CNN 통합 | 단일 모델이 아닌 여러 AI를 결합해 더 정교한 분석 |
...
| 👥 **팀 협업** | 모듈 분리 개발 (MediaPipe / YOLO / 통합) | 역할 분담 후 Git으로 코드 통합하는 협업 경험 |
...
*"카메라 하나로 자세와 환경을 동시에, AI가 실시간으로 교정해드립니다."* 🧘
